...
div.attach(
  div(
    ...
    p('Paragraph 4').setId('p4').hideIf(testState.hide4),
    p('Paragraph 5').setId('p5').hideIf(testState.hide5),
  ),
  br(),
  br(),
  ...
  button('Toggle 4').clicked(() => (testState.hide4 = !testState.hide4)),
  button('Toggle 5').clicked(() => (testState.hide5 = !testState.hide5)),
  br(),
