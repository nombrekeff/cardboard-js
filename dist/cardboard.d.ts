...
export declare const Cardboard: {
    ...
    intersect<T_1, K>(other: import("./types").IConsumable<T_1>, intersector: (val: T_1) => K): _consumables.Consumable<K>;
    greaterThan(consumable: import("./types").IConsumable<number>, val: number): _consumables.Consumable<boolean>;
    greaterThanOr(consumable: import("./types").IConsumable<number>, val: number): _consumables.Consumable<boolean>;
    lessThan(consumable: import("./types").IConsumable<number>, val: number): _consumables.Consumable<boolean>;
    lessThanOr(consumable: import("./types").IConsumable<number>, val: number): _consumables.Consumable<boolean>;
    equalTo<T_2>(consumable: import("./types").IConsumable<T_2>, val: T_2): _consumables.Consumable<boolean>;
    notEqualTo<T_3>(consumable: import("./types").IConsumable<T_3>, val: T_3): _consumables.Consumable<boolean>;
