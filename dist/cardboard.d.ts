...
export declare const Cardboard: {
    ...
    text: <T_11 extends Record<string, import("./types").Primitive>, K_2 extends import("./types").TextObj>(textTemplate: string, obj?: K_2 | import("./types").IConsumable<T_11> | undefined) => Node;
